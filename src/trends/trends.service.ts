...
export class TrendsService {
  ...
  //           value = this.formulasService.calculateOscillationIndex([]);
  //           break;

  //         case 'RPM_Stability_Index':
  //           value = this.formulasService.calculateRPMStabilityWithLoad([]);
  //           break;
  //         case 'OTSR':
  //           value = this.formulasService.calculateOTSRF(doc);
  //           break;
  ...
  //   });
  //   const results: any[] = [];
  //   const rawDocs: any[] = []; // Keep raw docs for window-based formulas

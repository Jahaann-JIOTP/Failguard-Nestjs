...
// // // // //   /** -------------------
// // // // //    * FIXED: Core Data Fetching Logic with Date Timestamp Support
// // // // //    * ------------------- */
// // // // //   private async fetchDashboardData(
// // // // //     mode: 'live' | 'historic' | 'range',
// // // // //     config: DashboardConfig,
...
// // // // //     // ✅ FIX: Use proper timestamp formatting for Date objects
// // // // //     const formattedData = data.map((doc) => ({
// // // // //       ...doc,
...
// // // // //   /** -------------------
// // // // //    * FIXED: Aggregation Pipeline for Date Timestamps
// // // // //    * ------------------- */
// // // // //   private buildAggregationPipeline(
// // // // //     mode: string,
// // // // //     projection: Record<string, number>,
...
// // // // //     // ✅ FIX: Handle Date objects correctly
// // // // //     if (mode === 'historic' && start && end) {
...
// // // // //       const yesterday = new Date();
// // // // //       yesterday.setDate(yesterday.getDate() - 1);
// // // // //       matchStage.timestamp = { $gte: yesterday };
// // // // //       console.log('Live mode query:', matchStage.timestamp);
// // // // //     }
...
// // // // //     // Sort stage - Date objects sort correctly chronologically
// // // // //     pipeline.push({ $sort: { timestamp: 1 } });
...
// // // // //         return timestamp.toISOString(); // Convert to ISO string format
// // // // //       }

// // // // //       // If it's already in ISO string format
...
// // // // //   /** -------------------
// // // // //    * NEW: On Duration Calculator for Date Timestamps
// // // // //    * ------------------- */
...
// // // // //         timestamp: doc.timestamp,
// // // // //         timestampType: typeof doc.timestamp,
// // // // //         isDateObject: doc.timestamp instanceof Date,
// // // // //         isoString:
// // // // //           doc.timestamp instanceof Date ? doc.timestamp.toISOString() : 'N/A',
// // // // //         Genset_Run_SS: doc.Genset_Run_SS,
// // // // //         formattedTimestamp: this.formatDateTimestamp(doc.timestamp),
// // // // //       })),
// // // // //       allRecordsCount: await this.collection.countDocuments(
// // // // //         pipeline[0]?.$match || {},
// // // // //       ),
...
// // // //   /** -------------------
// // // //    * FIXED: Core Data Fetching Logic with Date Validation
// // // //    * ------------------- */
// // // //   private async fetchDashboardData(
// // // //     mode: 'live' | 'historic' | 'range',
// // // //     config: DashboardConfig,
...
// // // //   /** -------------------
// // // //    * FIXED: Date Format Validation and Correction
// // // //    * ------------------- */
...
// // // //   //   // ✅ Remove any extra spaces and fix format
// // // //   //   let cleanedDate = dateString.trim();

// // // //   //   // If date has extra "00:00" at the end, remove it
// // // //   //   if (cleanedDate.includes(' 00:00')) {
// // // //   //     cleanedDate = cleanedDate.replace(' 00:00', '');
// // // //   //   }
...
// // // //   //   console.log(`Date converted: ${dateString} -> ${date.toISOString()}`);
// // // //   //   return date;
// // // //   // }

// // // //   // /** -------------------
// // // //   //  * UPDATED: Aggregation Pipeline with Date Validation
// // // //   //  * ------------------- */
// // // //   // private buildAggregationPipeline(
// // // //   //   mode: string,
// // // //   //   projection: Record<string, number>,
...
// // // //   //   // ✅ FIXED: Date validation and conversion for historic and range modes
...
// // // //   //       // Range mode mein Genset_Run_SS filter bhi add karo
// // // //   //       if (mode === 'range') {
// // // //   //         matchStage.Genset_Run_SS = { $gte: 1, $lte: 6 };
// // // //   //       }

// // // //   //       console.log(
// // // //   //         `${mode} mode - Validated date range:`,
// // // //   //         matchStage.timestamp,
// // // //   //       );
// // // //   //       if (mode === 'range') {
// // // //   //         console.log(
// // // //   //           'Range mode - Genset_Run_SS filter:',
// // // //   //           matchStage.Genset_Run_SS,
// // // //   //         );
// // // //   //       }
// // // //   //     } catch (error) {
...
// // // //   /** -------------------
// // // //    * FIXED: Aggregation Pipeline with Karachi Timezone
// // // //    * ------------------- */
// // // //   // private buildAggregationPipeline(
// // // //   //   mode: string,
// // // //   //   projection: Record<string, number>,
...
// // // //   //       const startUTC = new Date(startDate.getTime() - 5 * 60 * 60000);
// // // //   //       const endUTC = new Date(endDate.getTime() - 5 * 60 * 60000);
...
// // // //   //       console.log(
// // // //   //         `${mode} mode - Date range (UTC adjusted):`,
// // // //   //         matchStage.timestamp,
// // // //   //       );
// // // //   //     } catch (error) {
// // // //   //       console.error('Date validation error:', error.message);
...
// // // //   /** -------------------
// // // //    * NEW: Debug Database Content
// // // //    * ------------------- */
// // // //   async debugDatabaseContent() {
// // // //     console.log('=== DATABASE DEBUG INFO ===');

// // // //     // Get some sample records to check data structure
// // // //     const sampleRecords = await this.collection.find({}).limit(5).toArray();

// // // //     // Check date ranges in database
// // // //     const oldestRecord = await this.collection
// // // //       .find({})
// // // //       .sort({ timestamp: 1 })
// // // //       .limit(1)
// // // //       .toArray();
// // // //     const newestRecord = await this.collection
// // // //       .find({})
// // // //       .sort({ timestamp: -1 })
// // // //       .limit(1)
// // // //       .toArray();

// // // //     // Check Genset_Run_SS values distribution
// // // //     const gensetStats = await this.collection
// // // //       .aggregate([
// // // //         {
// // // //           $group: {
// // // //             _id: '$Genset_Run_SS',
...
// // // //     return {
// // // //       totalRecords: await this.collection.countDocuments(),
// // // //       sampleRecords: sampleRecords.map((record) => ({
// // // //         timestamp: record.timestamp,
// // // //         timestampType: typeof record.timestamp,
// // // //         isDate: record.timestamp instanceof Date,
// // // //         Genset_Run_SS: record.Genset_Run_SS,
// // // //       })),
// // // //       dateRange: {
// // // //         oldest: oldestRecord[0]?.timestamp,
// // // //         newest: newestRecord[0]?.timestamp,
// // // //       },
// // // //       gensetRunSSDistribution: gensetStats,
// // // //     };
// // // //   }

// // // //   /** -------------------
// // // //    * NEW: Test Specific Date Range
// // // //    * ------------------- */
// // // //   async testDateRange(start: string, end: string) {
// // // //     console.log('=== TESTING DATE RANGE ===');
// // // //     console.log('Testing dates:', { start, end });
...
// // // //       const sampleData = await this.collection.find(query).limit(3).toArray();
...
// // // //     console.log('Testing with dates:', { startStr, endStr });

// // // //     // Test Range Mode
// // // //     try {
// // // //       results.range = await this.getDashboardData(
// // // //         'dashboard1',
// // // //         'range',
// // // //         startStr,
// // // //         endStr,
...
// // // //     // Test Historic Mode
// // // //     try {
// // // //       results.historic = await this.getDashboardData(
// // // //         'dashboard1',
// // // //         'historic',
// // // //         startStr,
// // // //         endStr,
// // // //       );
// // // //     } catch (error) {
// // // //       results.historic = { error: error.message };
// // // //     }

// // // //     // Test Live Mode
// // // //     try {
// // // //       results.live = await this.getDashboardData('dashboard1', 'live');
// // // //     } catch (error) {
// // // //       results.live = { error: error.message };
// // // //     }

// // // //     return {
// // // //       testDates: { start: startStr, end: endStr },
// // // //       results,
// // // //     };
// // // //   }

// // // //   /** -------------------
// // // //    * UPDATED: Debug Method to Check Database Data
// // // //    * ------------------- */
// // // //   async debugDatabaseData(
// // // //     mode: 'live' | 'historic' | 'range' = 'live',
// // // //     start?: string,
...
// // // //         { $project: { timestamp: 1, Genset_Run_SS: 1 } },
// // // //         { $sort: { timestamp: 1 } },
// // // //         { $limit: limit },
// // // //       ];
// // // //     } else {
...
// // // //         formattedTimestamp: this.formatDateTimestamp(doc.timestamp),
// // // //       })),
// // // //       pipeline: pipeline.slice(0, 3), // Show first 3 stages for debugging
// // // //     };
// // // //   }
...
// // //   /** -------------------
// // //    * UPDATED: Core Data Fetching Logic with Mode-based Metrics
// // //    * ------------------- */
// // //   private async fetchDashboardData(
// // //     mode: 'live' | 'historic' | 'range',
// // //     config: DashboardConfig,
...
// // //     // ✅ REMOVE ZERO VALUES from metrics
// // //     metrics = this.removeZeroValues(metrics);
...
// // //   /** -------------------
// // //    * NEW: Remove Zero Values from Metrics
// // //    * ------------------- */
// // //   private removeZeroValues(metrics: Record<string, any>): Record<string, any> {
// // //     const cleanedMetrics: Record<string, any> = {};

// // //     for (const [key, value] of Object.entries(metrics)) {
// // //       // Skip if value is 0, null, undefined, or empty string
// // //       if (
// // //         value !== 0 &&
// // //         value !== null &&
// // //         value !== undefined &&
...
// // //           this.formulas.calculateCurrentImbalance(d),
// // //         voltageImbalance: (d: any) =>
// // //           this.formulas.calculateVoltageImbalance(d),
// // //         powerLossFactor: (d: any) => this.formulas.calculatePowerLossFactor(d),
// // //         thermalStress: (d: any) => this.formulas.calculateThermalStress(d),
// // //       };
...
// // //     } else {
// // //       const metricsConfig = {
// // //         intakeTemperature: (d: any) => d.Intake_Manifold3_Temperature ?? 0,
// // //         boostPressure: (d: any) => d.Boost_Pressure ?? 0,
// // //         avg_LL_Voltage: (d: any) => this.formulas.calculateAvgLLVoltage(d),
// // //         voltageImbalance: (d: any) =>
// // //           this.formulas.calculateVoltageImbalance(d),
// // //         coolingMarginF: (d: any) => this.formulas.calculateCoolingMarginF(d),
// // //         coolingMarginC: (d: any) => this.formulas.calculateCoolingMarginC(d),
// // //       };
...
// // //           this.formulas.calculateLubricationRiskIndex(d),
...
// // //         loadPercent: (d: any) => this.formulas.calculateLoadPercent(d),
// // //       };
...
// // //           this.formulas.calculateAirFuelEffectiveness(d),
// // //         specificFuelConsumption: (d: any) =>
// // //           this.formulas.calculateSpecificFuelConsumption(d),
// // //         heatRate: (d: any) => this.formulas.calculateHeatRate(d),
// // //         fuelOutletPressure: (d: any) => d.Fuel_Outlet_Pressure_calculated ?? 0,
// // //       };
...
// //   /** -------------------
// //    * NEW: Calculate Running Hours from Data
// //    * ------------------- */
...
// //     // REMOVED: runningHours from here since it's now calculated separately
// //     fuelConsumed: (doc: any) => doc.Total_Fuel_Consumption_calculated || 0,
// //     batteryVoltage: (doc: any) => doc.Battery_Voltage_calculated || 0,
// //     powerFactor: (doc: any) => doc.Genset_Total_Power_Factor_calculated || 0,
// //   };
...
//   /** -------------------
//    * UPDATED: Core Data Fetching Logic with Zero-fill and Genset Filter
//    * ------------------- */
//   private async fetchDashboardData(
//     mode: 'live' | 'historic' | 'range',
//     config: DashboardConfig,
...
//     // ✅ Format timestamps to ISO string and fill missing fields with zero
//     const formattedData = data.map((doc) => ({
...
//   /** -------------------
//    * NEW: Fill Missing Fields with Zero
//    * ------------------- */
...
//   /** -------------------
//    * UPDATED: Charts Mapping Functions with Zero-fill
//    * ------------------- */
//   private mapCharts(data: any[], definitions: any) {
//     const charts: Record<string, any[]> = {};
...
//         const entry: any = { time: d.timestamp };
//         definitions[chartName].forEach((field: string) => {
//           // 🔥 UPDATED: Fill missing chart fields with zero
//           entry[field] = d[field] ?? 0;
//         });
//         return entry;
//       });
//     }

//     // Special charts with zero-fill
//     charts.CurrentImbalanceNeutral = data.map((d) => ({
//       time: d.timestamp,
...
export class DashboardService {
   ...
   * ------------------- */
  private fillMissingFieldsWithZero(doc: any, projection: Record<string, number>): any {
    const filledDoc = { ...doc };
    
    // Get all fields from projection (excluding timestamp)
    const projectedFields = Object.keys(projection).filter(field => field !== 'timestamp');
   ...
   * NEW: Enhanced Data Validation Logging
   * ------------------- */
  private logDataValidation(data: any[], mode: string, projection: Record<string, number>) {
    if (data.length === 0) {
      console.log(`=== NO DATA for ${mode.toUpperCase()} MODE ===`);
      return;
    }
    ...
    const missingFields = projectedFields.filter(field => 
      firstRecord[field] === undefined || firstRecord[field] === null
    );
    ...
    // Check Genset_Run_SS for range mode
    if (mode === 'range') {
      const gensetValues = data.map(d => d.Genset_Run_SS).filter(val => val !== undefined);
      const validGensetValues = gensetValues.filter(val => val >= 1 && val <= 6);
      
      console.log(`Genset_Run_SS values: ${gensetValues.length} total, ${validGensetValues.length} valid (1-6)`);
    ...
    if (data.length >= 2) {
      ...
      const secondTime = new Date(data[1].timestamp).getTime();
      const intervalMs = secondTime - firstTime;
      console.log(`Approximate interval between records: ${intervalMs / 1000} seconds`);
    }
   ...
   * UPDATED: Remove Zero Values but Keep Important Metrics
   * ------------------- */
  private removeZeroValuesButKeepImportant(metrics: Record<string, any>): Record<string, any> {
    const cleanedMetrics: Record<string, any> = {};
    const importantMetrics = [
      'runningHours', 
      'onDurationMinutes', 
  ...
  private mapMetricsDashboard2WithMode(
    ...
    if (mode === 'live') {
      ...
      const metricsConfig = {
        ...
        voltageImbalance: (d: any) =>
          this.formulas.calculateVoltageImbalance(d) || 0,
        powerLossFactor: (d: any) => this.formulas.calculatePowerLossFactor(d) || 0,
        thermalStress: (d: any) => this.formulas.calculateThermalStress(d) || 0,
      };
  ...
  private mapMetricsDashboard3WithMode(doc: any, data: any[], mode: string) {
    if (mode === 'live') {
      ...
      const metricsConfig = {
        ...
        voltageImbalance: (d: any) =>
          this.formulas.calculateVoltageImbalance(d) || 0,
        coolingMarginF: (d: any) => this.formulas.calculateCoolingMarginF(d) || 0,
        coolingMarginC: (d: any) => this.formulas.calculateCoolingMarginC(d) || 0,
      };
  ...
  private mapMetricsDashboard4WithMode(doc: any, data: any[], mode: string) {
    if (mode === 'live') {
      return {
        lubricationRiskIndex: this.formulas.calculateLubricationRiskIndex(doc) || 0,
        oilPressure: doc.Oil_Pressure ?? 0,
        engineSpeed: doc.Averagr_Engine_Speed ?? 0,
        boostPressure: doc.Boost_Pressure ?? 0,
        fuelOutletPressure: doc.Fuel_Outlet_Pressure_calculated ?? 0,
  ...
  private mapMetricsDashboard5WithMode(doc: any, data: any[], mode: string) {
    if (mode === 'live') {
      return {
        fuelRate: doc.Fuel_Rate ?? 0,
        loadPercent: this.formulas.calculateLoadPercent(doc) || 0,
        airFuelEffectiveness: this.formulas.calculateAirFuelEffectiveness(doc) || 0,
        specificFuelConsumption:
          this.formulas.calculateSpecificFuelConsumption(doc) || 0,
        heatRate: this.formulas.calculateHeatRate(doc) || 0,
        fuelOutletPressure: doc.Fuel_Outlet_Pressure_calculated ?? 0,
  ...
  private mapChartsDashboard3(data: any[]): Record<string, any[]> {
    ...
    charts.intakeBoost = data.map((d) => ({
      time: d.timestamp,
      Intake_Manifold3_Temperature: d.Intake_Manifold3_Temperature ?? null,
  ...
  private mapChartsDashboard4(data: any[]): Record<string, any[]> {
    ...
    charts.lubricationRiskIndex = data.map((d) => ({
      ...
      Lubrication_Risk_Index: this.formulas.calculateLubricationRiskIndex(d) || 0,
    }));
    ...
    charts.boostFuelOutlet = data.map((d) => ({
      time: d.timestamp,
      Boost_Pressure: d.Boost_Pressure ?? null,
      Fuel_Outlet_Pressure_calculated: d.Fuel_Outlet_Pressure_calculated ?? null,
    }));
